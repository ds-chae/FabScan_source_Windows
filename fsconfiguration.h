...
/* replaced to FSCamPosition
	float _CAM_POS_X; //precise by construction
    float _CAM_POS_Y;
    float _CAM_POS_Z;
*/
	...
	double TURNTABLE_STEPS_360; // Number of steps per 360* of turntable
...
public:
    ...
    bool readConfiguration(bool mode);							//Mode is so that on initialization readConfiguration won't complain if file not found
    void interprate();
};
